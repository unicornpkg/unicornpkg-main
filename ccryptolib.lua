...
package.instdat.filemaps["ccryptolib/config.lua"] = "/lib/ccryptolib/config.lua"
...
package.instdat.filemaps["ccryptolib/internal/mp.lua"] = "/lib/ccryptolib/internal/hw.lua"
